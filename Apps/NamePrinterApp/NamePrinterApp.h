...
#ifndef OPENTRADINGSYSTEM_NAMEPRINTERAPP_H
#define OPENTRADINGSYSTEM_NAMEPRINTERAPP_H
...
namespace OTSApps
{
    class NamePrinterApp : public OTSLibrary::App {
    public:
        ...
        REGISTER_PLUGIN(NamePrinterApp)
        REGISTER_VERSION()
    };
}

BOOST_DLL_ALIAS(OTSApps::NamePrinterApp::create, create_app)


#endif //OPENTRADINGSYSTEM_NAMEPRINTERAPP_H
